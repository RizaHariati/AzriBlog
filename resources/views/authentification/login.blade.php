...
@section('container')
  ...
  <form action="/login" method="post">
    @csrf
    <img class="mb-4" src="{{ asset('assets/images/lotus.png') }}" alt=""
      width="72" height="72">
    ...
    <p class="mt-2 mb-2 text-muted">don't have any account? <a href="/registers"
        class="text-info">please register</a>
    </p>
